...
//@interface BeerShiftObject : NSObject
//@end

@interface BeerShiftObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BeerShiftObject class]])
		{
			for (NSString *key in [[(BeerShiftObject*)o modules] allKeys])
			{
